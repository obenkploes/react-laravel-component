...
export default function Datatable({ url, crud = false, column = [], onAdd, onEdit, onDelete }) {
    ...
    return (
        <>
            <div className="dt-header w-full flex items-center justify-between">
                ...
                {crud && (
                    <button className={`${btn_primary} flex items-center gap-2`} onClick={() => onAdd(mutate)}>
                        <IconAdd />
                                ...
                                {crud && (
                                    <td>
                                        <div className="flex items-center gap-2 justify-center">
                                            <button className='text-green-700 hover:text-gray-950' onClick={() => onEdit(e,mutate)}><IconEdit /></button>
                                            <button className='text-red-500 hover:text-red-700' onClick={() => onDelete(e,mutate)}><IconDelete /></button>
                                        </div>
                                    </td>
                                )}
                            </tr>
